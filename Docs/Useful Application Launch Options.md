To add these launch options, open the application launcher (start menu), right click the application that you want to add it to, and click "Edit Application."
